...
class MarkdownPreviewManager extends dispose_1.Disposable {
    ...
    _contributions;
    _opener;
    _topmostLineMonitor = new topmostLineMonitor_1.TopmostLineMonitor();
    _previewConfigurations = new previewConfig_1.MarkdownPreviewConfigurationManager();
    _dynamicPreviews = this._register(new PreviewStore());
    _staticPreviews = this._register(new PreviewStore());
