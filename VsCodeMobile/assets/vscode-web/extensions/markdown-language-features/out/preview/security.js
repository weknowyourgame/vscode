...
class ExtensionContentSecurityPolicyArbiter {
    _globalState;
    _workspaceState;
    _old_trusted_workspace_key = 'trusted_preview_workspace:';
    _security_level_key = 'preview_security_level:';
    _should_disable_security_warning_key = 'preview_should_show_security_warning:';
