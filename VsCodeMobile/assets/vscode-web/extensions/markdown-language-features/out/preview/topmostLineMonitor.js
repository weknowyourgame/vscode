...
class TopmostLineMonitor extends dispose_1.Disposable {
    _pendingUpdates = new resourceMap_1.ResourceMap();
    _throttle = 50;
    _previousTextEditorInfo = new resourceMap_1.ResourceMap();
    _previousStaticEditorInfo = new resourceMap_1.ResourceMap();
    constructor() {
        super();
    ...
    _onChanged = this._register(new vscode.EventEmitter());
    onDidChanged = this._onChanged.event;
