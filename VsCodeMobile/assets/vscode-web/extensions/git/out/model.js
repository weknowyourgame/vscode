...
let RepositoryPick = (() => {
    ...
    let _get_iconPath_decorators;
    return class RepositoryPick {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _get_label_decorators = [decorators_1.memoize];
            _get_description_decorators = [decorators_1.memoize];
            _get_iconPath_decorators = [decorators_1.memoize];
            __esDecorate(this, null, _get_label_decorators, { kind: "getter", name: "label", static: false, private: false, access: { has: obj => "label" in obj, get: obj => obj.label }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _get_iconPath_decorators, { kind: "getter", name: "iconPath", static: false, private: false, access: { has: obj => "iconPath" in obj, get: obj => obj.iconPath }, metadata: _metadata }, null, _instanceExtraInitializers);
...
let Model = (() => {
    let _instanceExtraInitializers = [];
    let _get_isInitialized_decorators;
    let _eventuallyScanPossibleGitRepositories_decorators;
    let _openRepository_decorators;
    return class Model {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _get_isInitialized_decorators = [decorators_1.memoize];
            _eventuallyScanPossibleGitRepositories_decorators = [(0, decorators_1.debounce)(500)];
            _openRepository_decorators = [decorators_1.sequentialize];
            __esDecorate(this, null, _get_isInitialized_decorators, { kind: "getter", name: "isInitialized", static: false, private: false, access: { has: obj => "isInitialized" in obj, get: obj => obj.isInitialized }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _eventuallyScanPossibleGitRepositories_decorators, { kind: "method", name: "eventuallyScanPossibleGitRepositories", static: false, private: false, access: { has: obj => "eventuallyScanPossibleGitRepositories" in obj, get: obj => obj.eventuallyScanPossibleGitRepositories }, metadata: _metadata }, null, _instanceExtraInitializers);
