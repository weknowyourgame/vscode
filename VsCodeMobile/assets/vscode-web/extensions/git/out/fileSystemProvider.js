...
let GitFileSystemProvider = (() => {
    let _instanceExtraInitializers = [];
    let _eventuallyFireChangeEvents_decorators;
    let _fireChangeEvents_decorators;
    return class GitFileSystemProvider {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _eventuallyFireChangeEvents_decorators = [(0, decorators_1.debounce)(1100)];
            _fireChangeEvents_decorators = [decorators_1.throttle];
            __esDecorate(this, null, _eventuallyFireChangeEvents_decorators, { kind: "method", name: "eventuallyFireChangeEvents", static: false, private: false, access: { has: obj => "eventuallyFireChangeEvents" in obj, get: obj => obj.eventuallyFireChangeEvents }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _fireChangeEvents_decorators, { kind: "method", name: "fireChangeEvents", static: false, private: false, access: { has: obj => "fireChangeEvents" in obj, get: obj => obj.fireChangeEvents }, metadata: _metadata }, null, _instanceExtraInitializers);
