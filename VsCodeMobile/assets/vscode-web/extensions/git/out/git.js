...
function getGitErrorCode(stderr) {
    if (/Another git process seems to be running in this repository|If no other git process is currently running/.test(stderr)) {
        ...
        return "WorktreeContainsChanges" /* GitErrorCodes.WorktreeContainsChanges */;
    }
    else if (/fatal: '[^']+' already exists/.test(stderr)) {
        return "WorktreeAlreadyExists" /* GitErrorCodes.WorktreeAlreadyExists */;
    }
    else if (/is already used by worktree at/.test(stderr)) {
        return "WorktreeBranchAlreadyUsed" /* GitErrorCodes.WorktreeBranchAlreadyUsed */;
    }
    return undefined;
}
...
class Repository {
    ...
    async diffBetween2(ref1, ref2, options) {
